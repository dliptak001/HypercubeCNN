...
[![PyPI](https://img.shields.io/pypi/v/hypercube-cnn)](https://pypi.org/project/hypercube-cnn/)
[![Python](https://img.shields.io/pypi/pyversions/hypercube-cnn)](https://pypi.org/project/hypercube-cnn/)
...
# MNIST: place IDX files in C:\HypercubeCNN\data (see examples/mnist_train.md)
```
...
| **[ChangeLog.md](ChangeLog.md)** | Release notes (v1.0.5 latest; v1.0.0 public SDK arc) |
